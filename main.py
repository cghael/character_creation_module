...
def start_training(character: Type[Character]):
    """
...
#     """Защита определенным персонажем."""
#     if char_class == 'warrior':
...
#     """Персонаж применяет специальные способности."""
#     if char_class == 'warrior':
...
#     """Тренеровка управления персонажем."""
#     if char_class == 'warrior':
...
#     """Выбор игроком класса своего персонажа."""
#     approve_choice: str = ''
#     char_class: str = ''
#     while approve_choice != 'y':
